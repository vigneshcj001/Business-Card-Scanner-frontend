  ...
  async function saveEdit() {
    ...
    try {
      ...
      const payload = {
        ...
        company: editPayload.company || null,
        phone_numbers: editPayload.phone_numbers || [],
        email: editPayload.email || null,
        website: editPayload.website || null,
        address: editPayload.address || null,
        social_links: editPayload.social_links || [],
        more_details: editPayload.more_details || "",
      ...
      setContacts((list) =>
        list.map((c) =>
          String(c._id) === String(editingId)
            ? { ...c, ...payload, _id: String(editingId) }
            : c
        )
      );
